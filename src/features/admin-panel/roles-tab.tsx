    ...
    <div className="flex flex-col gap-4 overflow-hidden py-1 px-3">
      ...
      {/* <div className="flex flex-col gap-4 p-4 shadow-sm sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-[18px] font-bold text-gray-900">Roles & Rights</h2>
            <p className="mt-0.5 text-[14px] font-medium text-gray-400">
              Configure roles and the rights assigned to them.
            </p>
          </div>
        </div>

        <div className="text-right">
          <span className="block text-[14px] font-bold uppercase tracking-wide text-gray-400">
            {subTab === 'roles' ? 'Total Roles' : 'Total Rights'}
          </span>
          <span className="text-[20px] font-bold text-gray-900">{subTab === 'roles' ? roles.length : rights.length}</span>
        </div>
      </div> */}
