...
export function LoginPage() {
  ...
  return (
    ...
    >
      ...
      {/* Login Card */}
      <div
        className="relative w-[calc(100vw-32px)] md:w-[420px] h-[380px] rounded-[24px] bg-white/10 border-[2px] border-white/75 flex flex-col items-center px-6 z-10"
        style={{
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="w-full mt-[85px] flex flex-col z-20">
